...
為便於廣泛傳播乾淨世界節目（僅限公開和免費的節目），包括其各類真相節目，讓眾人明真相，特製作此乾淨世界視頻節目下載器。
...
可以直接點擊“打開下載目錄”按鈕來打開“下載”目錄，然後在其下找到以視頻文件名命名的子目錄，如上圖中的“我們告訴未來 第一集： 氣功鋪路”目錄，下載成功后，所下載的視頻就保存在這個子目錄下。
